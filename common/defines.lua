...
NDiplomacy = {
	...
	ALLY_AE_MULT = 1,								-- Taking things from allies that are not fully called into the war generates this much more AE
...
NCountry = {
	...
	MAX_IDEA_GROUPS_FROM_SAME_CATEGORY = 0,
	...
	MAXIMUM_ADVISOR_SKILL = 8,						-- Maximum advisor skill reachable through promotion
...
NNationDesigner = {
	...
	IDEAS_PERCENTAGE_LIMIT = 0,			-- Max % from any one category to not get overstacking penalty
